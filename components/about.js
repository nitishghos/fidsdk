...
import { resumeLink } from "../utils"; // Removed CheckMarkIcon and timeline import
        ...
        <div className="about-section-inner">
          ...
          <div className="about-me">
            ...
            <ul className="about-desc">
              <li>
              As a fresher in Software Development, I bring a strong foundation in Frontend Web Development using <b>JavaScript</b> and <b>ReactJS</b>.
              </li>
              <li>
                Currently, I'm diving into the world of App Development using <b>React Native</b> and <b>SwiftUI</b> to diversify my skills.
              </li>
              <li>
                I have graduated from <b>School of Enginnering, Lovely Professional University</b> in the year 2026, pursuing B.Tech in Computer Science and Engineering.
              </li>
              <li>
                As a keen learner and attentive collaborator, I thrive on crafting efficient and scalable solutions.
              </li>
              <li>
                Other than being a Software Engineer, I love to <b>workout</b> 4 times a week. When time permits, I love to <b>travel</b>, <b>read blogs</b>, play &amp; watch Batmintan.
              </li>
            </ul>
          </div>
        </div>
